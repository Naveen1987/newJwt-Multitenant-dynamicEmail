...
@Component
public class Logout_SuccessHandler extends SimpleUrlLogoutSuccessHandler{
    ...
    public void onLogoutSuccess(javax.servlet.http.HttpServletRequest request, 
    	...
    	try {
    	    ...
    	    TokenAuthenticationService tokenAuthenticationService = webApplicationContext.getBean(TokenAuthenticationService.class);*/
