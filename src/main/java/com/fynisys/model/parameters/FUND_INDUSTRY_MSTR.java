...
@Entity
@Table(name="FUND_INDUSTRY_MSTR",uniqueConstraints=
{
@UniqueConstraint(columnNames="SVI_NAME",name="SECTORNAME_UNIQUE"),
@UniqueConstraint(columnNames="SVI_SHORT_NAME",name="SECTORSHORTNAME_UNIQUE")
})
public class FUND_INDUSTRY_MSTR implements Serializable {
	...
	public String toString() {
		return "FUND_INDUSTRY_MSTR [SVI_CODE=" + SVI_CODE + ", SVI_NAME=" + SVI_NAME + ", SVI_ANAME=" + SVI_ANAME
				+ ", SVI_SHORT_NAME=" + SVI_SHORT_NAME + ", SVI_DATE=" + SVI_DATE + ", SVC_UID=" + SVC_UID
